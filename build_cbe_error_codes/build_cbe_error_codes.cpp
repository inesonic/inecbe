    ...
    if (argumentCount != 2) {
        ...
        if (!outputFile.open(QFile::OpenModeFlag::WriteOnly | QFile::OpenModeFlag::Text)) {
        ...
        } else {
            {
                ...
                os << "/*-*-c++-*-***********************************************************************************"
                   << "**************************" << eol
                   << "* Copyright 2016 - 2022 Inesonic, LLC." << eol
                   << "*" << eol
                   << "* This file is licensed under two licenses." << eol
                   << "*" << eol
                   << "* Inesonic Commercial License, Version 1:" << eol
                   << "*   All rights reserved.  Inesonic, LLC retains all rights to this software, including the "
                      "right to relicense the" << eol
                   << "*   software in source or binary formats under different terms.  Unauthorized use under the "
                      "terms of this license is" << eol
                   << "*   strictly prohibited." << eol
                   << "*" << eol
                   << "* GNU Public License, Version 2:" << eol
                   << "*   This program is free software; you can redistribute it and/or modify it under the terms of "
                      "the GNU General Public" << eol
                   << "*   License as published by the Free Software Foundation; either version 2 of the License, or "
                      "(at your option) any later" << eol
                   << "*   version." << eol
                   << "*" << eol
                   << "*   This program is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; "
                      "without even the implied" << eol
                   << "*   warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU General "
                      "Public License for more" << eol
                   << "*   details." << eol
                   << "*" << eol
                   << "*   You should have received a copy of the GNU General Public License along with this program; "
                      "if not, write to the Free" << eol
