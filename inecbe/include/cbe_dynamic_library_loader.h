...
* \file
*
* This header defines the \ref Cbe::DynamicLibraryLoader class.
***********************************************************************************************************************/

/* .. sphinx-project inecbe */

#ifndef CBE_DYNAMIC_LIBRARY_LOADER_H
#define CBE_DYNAMIC_LIBRARY_LOADER_H
...
namespace Cbe {
    ...
    /**
     * Class that provides support for loading and unloading of dynamic libraries on demand.  This class is simply a
     * thin wrapper on the QLibrary class.
     */
    class CBE_PUBLIC_API DynamicLibraryLoader {
        public:
            /**
             * Constructor
             *
             ...
             */
            DynamicLibraryLoader(LoaderNotifier* newNotifier = nullptr);
            ...
            /**
             * Method you can call to determine if a library is not loaded.
             *
             * \return Returns true if the library is not loaded.  Returns false if the library is loaded.
             */
             ...
             *         type.
             */
            void* resolve(const QString& symbolName) const;
