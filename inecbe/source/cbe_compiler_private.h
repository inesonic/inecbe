...
* \file
*
* This header defines the Cbe::Compiler::Private class.
***********************************************************************************************************************/

/* .. sphinx-project inecbe */

#ifndef CBE_COMPILER_PRIVATE_H
#define CBE_COMPILER_PRIVATE_H
...
namespace Cbe {
    ...
    /**
     * Underlying implementation for the private compiler implementation class.  This class is a very thin wrapper on
     * the \ref CompilerImpl class that contains the actual implementation.  This class exists to decouple call-backs
     * from the interface from the underlying implementation.
     */
    class CBE_PUBLIC_API Compiler::Private:public CompilerImpl {
        public:
            /**
             * Constructor
             *
             * \param[in] newNotifier The notifier to receive status updates on the compiler activity.
             *
             * \param[in] interface   Pointer to the interface class to receive callbacks.
             */
            Private(CompilerNotifier* newNotifier, Cbe::Compiler* interface);
        ...
        protected:
             ...
             * Overload this method in derived classes to make specific compilers for C++, ANSI-C, AST, etc.
             *
            ...
            /**
             * Method that is called when the compiler is started.  This method forwards the notification to the
             * interface.
             *
             ...
             */
            void compilerStarted(QSharedPointer<CompilerContext> context) final;

            /**
             * Pure virtual method that is called when the compiler has completed processing a context.  This method
             * forwards the notification to the interface.
             *
             * Note that this method may be called from a different thread than was used to invoke the compiler.
             *
             * \param[in] context    The context that is being executed.
             ...
             *                       error was detected.
             */
            void compilerFinished(QSharedPointer<CompilerContext> context, bool successful) final;
             ...
             *
             * \param[in] diagnosticLevel   A value from the enumeration \ref Cbe::CompilerDiagnostic::Level indicating
             *                              the type of diagnostic being reported.
             *
